...
{
    // Server instance
    // Slightly faster than calling Server.getInstance() every time
    ...
    // Player's position in the game (double instead of float for additional precision)
    ...
    ///
    /// @return an array of <code>LeaderboardRow</code> objects of length less
    ...
    ///
    /// @return an array of <code>GamesListRow</code> objects
