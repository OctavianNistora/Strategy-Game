...
public class GameSession
{
    ...
    public GameSession(int gameId, String gameName, Player player)
    {
        ...
        GameSessionBroadcastThread gameSessionBroadcastThread = new GameSessionBroadcastThread(this);
        this.gameSessionBroadcastThread = new Thread(gameSessionBroadcastThread);
    ...
    /// @return True if the player's ready status was changed successfully, false otherwise.
    ...
    private void tryStartGame()
    {
        ...
        Thread gameSessionSpawnerThread = new Thread(new GameSessionSpawnerThread(this));
    ...
    public boolean tryRemoveMaterialFromStructure(MaterialEnum materialType, int structureId)
    {
        synchronized (structures)
        {
            ...
            if (!structure.tryRemoveProgress(materialType))
            {
                return false;
            }
